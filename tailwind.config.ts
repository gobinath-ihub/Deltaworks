...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "hero-gradient": "linear-gradient(135deg, hsl(220 45% 15%) 0%, hsl(220 50% 8%) 100%)",
        "copper-gradient": "linear-gradient(135deg, hsl(25 80% 55%) 0%, hsl(25 75% 45%) 100%)",
        "subtle-gradient": "linear-gradient(180deg, hsl(210 20% 98%) 0%, hsl(210 15% 94%) 100%)",
      },
      boxShadow: {
        glow: "0 0 40px hsl(25 80% 55% / 0.2)",
        "card-hover": "0 25px 50px -12px hsl(220 30% 12% / 0.15)",
      },
    },
  },
